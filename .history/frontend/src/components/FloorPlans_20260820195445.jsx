          ...
          {floorPlans.map((plan, index) => (
            <div className="floor-plan-card" key={index}>
              ...
              <div className="floor-plan-details">
                <p className="floor-plan-project">THANEKAR DNSB</p>
                <h3 className="floor-plan-title">{plan.title}</h3>

                <div className="gold-divider">
                  <span></span>
                </div>

                <a className="view-plan-btn" href={plan.pdf} target="_blank" rel="noopener noreferrer">
                  View Plan→
                </a>
              </div>
            </div>
