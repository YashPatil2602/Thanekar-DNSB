function About() {
    return ( <
        ...
        residential and commercial development in Badlapur,
        offering modern homes and premium retail shops in a well - connected location. <
        /p>
        ...
        <
        div className = "about-block developer-block" >
        ...
        <
        p >
        Along with developing premium residences, Mr.Ajay Thanekar is deeply passionate about nurturing young minds by empowering children with confidence, opportunities, and a brighter future. <
        /p>
