...
function About() {
    return ( <
        ...
        <
        img src = "/images/about/about-building.jpg"
        ...
        trusted real estate developers, having successfully delivered more than 57 projects to date.We have consistently ensured that our customers ' expectations
        ...
        <
        p >
        Along with developing premium residences, Mr.Ajay Thanekar is deeply passionate about nurturing young minds by empowering children with confidence, opportunities,
        and a brighter future. <
        /p>

        <
        p className = "developer-last-line" >
