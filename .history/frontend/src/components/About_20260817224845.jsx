...
function About() {
    return ( <
        ...
        p >
        <
        strong > Thanekar DNSB < /strong> is a thoughtfully designed
        residential and commercial development in Badlapur, offering modern homes and premium retail shops in a well - connected location. <
        /p>
        ...
        <
        p className = "developer-small-title" >
        ABOUT DEVELOPER <
        /p>
        ...
        <
        p >
        Thanekar Group is a real estate company started by Mr.Ajay Madhukar Thanekar in 1991. In 1991, establishing a real estate company was difficult and inconceivable,
        especially
        ...
        <
        p >
        Thanekar Group is one of India’ s pioneering and most trusted real estate developers, having successfully delivered more than 57 projects to date.We have consistently ensured that our customers’ expectations are not only met but exceeded, through quality,
        ...
        p >
        Driven by a passion
        for excellence, our journey began with the vision and dedication of our founder,
        ...
        <
        p >
        Along with developing premium residences, Mr.Ajay Thanekar is deeply passionate about nurturing young minds by empowering children with confidence,
