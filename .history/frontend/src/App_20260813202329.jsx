...
const amenities = [{
        icon: "🎉",
        title: "Party Hall",
        text: "A dedicated space for celebrations and special family moments.",
    },
    {
        icon: "🏋️",
        title: "Open Gym",
        text: "An open fitness space designed for an active lifestyle.",
    },
    {
        icon: "🌳",
        title: "Garden",
        text: "Landscaped green spaces for relaxation and leisure.",
    },
    {
        icon: "🏡",
        title: "Gazebo",
        text: "A peaceful outdoor space to relax and spend quality time.",
    },
];
...
function App() {
    ...
    useEffect(() => {
        const timer = setInterval(() => {
            setCurrentHero((previous) => {
                return previous === heroImages.length - 1 ?
                    0 :
                    previous + 1;
            });
        }, 5000);
    ...
    return ( <
        ...
        for visibility, accessibility and business growth. <
        /p>
        ...
        for practical and comfortable family living. <
        /p>
        ...
        *
        ...
        <
        p >
        Thanekar Group is one of India’ s pioneering and most trusted real estate developers,
        having successfully delivered more than 57 projects to date. <
        /p>

        <
        p >
        We have consistently ensured that our customers ' expectations are not only met
        but exceeded, through quality, innovation and transparency. <
        /p>
        ...
        <
        h2 >
        Stay Connected With Thanekar Group <
        /h2>
